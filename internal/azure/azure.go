...
func AddToProduct(id string) error {
	var client = &http.Client{}
	req, err := http.NewRequest(http.MethodPut, "https://hka-lab-api-management.management.azure-api.net/subscriptions/1ed07f18-4c8e-424d-bd80-19e1247574ad/resourceGroups/RG-APIGenerator/providers/Microsoft.ApiManagement/service/hka-lab-api-management/products/starter/apis/"+id+"?api-version=2021-08-01", nil)
	if err != nil {
		return err
	}
	...
	if resp.StatusCode != 200 && resp.StatusCode != 204 && resp.StatusCode != 202 && resp.StatusCode != 201 {
		return fmt.Errorf(string(body))
	}
	return nil
}
